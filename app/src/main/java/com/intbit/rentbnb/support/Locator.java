...
public class Locator implements LocationListener
{
    ...
    private void requestUpdates(String provider)
    {
        if (this.locationManager.isProviderEnabled(provider))
        {
            ...
            //else if (provider.contentEquals(LocationManager.GPS_PROVIDER) && Connectivity.(this.context))
            else if (provider.contentEquals(LocationManager.GPS_PROVIDER) && Connectivity.isConnectedWifi(this.context))
            {
