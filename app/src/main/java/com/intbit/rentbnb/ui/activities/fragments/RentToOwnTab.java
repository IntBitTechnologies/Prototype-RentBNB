...
public class RentToOwnTab extends RentbnbBaseFragment implements RentBnbOnFragmentSelectedListener {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_renttoown, container, false);
    ...
    private void initializeViews(View view) {
        mRecyclerView = (RecyclerView) view.findViewById(R.id.renttoownTab_productsList_recyclerView);
    ...
    public void onFragmentSelected(FragmentManager fragmentManager, ViewPager viewPager, int position, Fragment fragment) {
        if (fragment instanceof RentToOwnTab) {
            getData(RentBnbEnums.Offers_View_Grid.toInt());
        }
    }
