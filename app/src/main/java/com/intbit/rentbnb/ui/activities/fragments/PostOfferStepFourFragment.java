...
public class PostOfferStepFourFragment extends RentbnbBaseFragment implements RentBnbOnFragmentSelectedListener {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        step_coverage_next_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Preferences.setCurrentPage(5);
                ((PostOfferActivity) getActivity()).changefragmentalongStepProcess(5);
            }
        });
