...
public class BuyTab extends RentbnbBaseFragment implements RentBnbOnFragmentSelectedListener {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tab_buy, container, false);
    ...
    private void initializeViews(View view) {
        mRecyclerView = (RecyclerView) view.findViewById(R.id.buyTab_productsList_recyclerView);
    ...
    public void getData(int viewType) {
        ...
        List<Offer> allBuyProductsList = dataManager.getAllBuyOffers();
        ...
        mAdapter =  new OfferListRecyclerViewAdapter(allBuyProductsList, mContext, viewType);
